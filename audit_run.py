#!/usr/bin/env python3
"""Audyt: transferable moc each channelu LST (leave-one-out), grupami."""
...
GROUP = { # typ channelu
 "p_low":"spektr","p_mid":"spektr","p_high":"spektr","fiedler":"spektr","eff_mass":"spektr",
 "commute":"spektr","hks5":"spektr","hks20":"spektr","hks60":"spektr","ipr":"spektr","degree":"spektr",
 "yukawa0.1":"coded","yukawa0.5":"coded","yukawa2.0":"coded",
 "interf_T10":"interf","interf_T20":"interf","interf_T40":"interf",
 "quadrature":"FAZA","phase_coh":"FAZA","gauge_coh":"FAZA","gauge_interf":"FAZA",
 "coherent":"superpoz","communic":"komunik"}
...
def main():
    ...
    print("Transferable moc channelu (leave-one-out, sign ustalony on training set):\n")
    rows = []
